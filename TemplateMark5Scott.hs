...
module TemplateMark5Scott where
...
extraPreludeDefs =
  ...
  , ("and", ["b1", "b2", "t", "f"], EAp (EAp (EVar "b1") (EAp (EVar "t") (EVar "f"))) (EVar "f"))
  , ("or", ["b1", "b2", "t", "f"], EAp (EAp (EVar "b1") (EVar "t")) (EAp (EVar "t") (EVar "f")))
...
-- exercise 2.29
--   case-pair
--     normal        -  test testCasePair        - 60 step
--     scott encoded -  test testScCasePair      - 31 step
--   print-list
--     normal        -  testList testPrintList   - 85 step
--     scott encoded -  testList testPrintScList - 47 step
